import{_ as u,r as a,o as r,c as k,a as n,b as s,d as t,e as d,w as e,h as m}from"./app-ac23c540.js";const v={},b=n("h1",{id:"文章分栏布局",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#文章分栏布局","aria-hidden":"true"},"#"),s(" 文章分栏布局")],-1),g={href:"https://developer.mozilla.org/zh-CN/docs/Web/CSS/columns",target:"_blank",rel:"noopener noreferrer"},h=n("p",null,"为了方便直接使用，做了一个 css 文件。",-1),y=n("div",{class:"language-scss line-numbers-mode","data-ext":"scss"},[n("pre",{class:"language-scss"},[n("code",null,[n("span",{class:"token keyword"},"@use"),s(),n("span",{class:"token string"},"'@sass-palette/hope-config'"),n("span",{class:"token punctuation"},";"),s(`
