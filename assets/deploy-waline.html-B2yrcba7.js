import{_ as a,c as s,b as e,d as n,o as t}from"./app-CTOS_cyU.js";const l={},p=n('<h1 id="waline-部署" tabindex="-1"><a class="header-anchor" href="#waline-部署"><span>Waline 部署</span></a></h1><p><a href="https://waline.js.org/" target="_blank" rel="noopener noreferrer">Waline</a> 是一款简洁、安全的评论系统。</p><h2 id="独立部署" tabindex="-1"><a class="header-anchor" href="#独立部署"><span>独立部署</span></a></h2><p>本次使用 Docker 独立部署，以便方便内网使用。</p>',4),i=n(`<h2 id="部署脚本" tabindex="-1"><a class="header-anchor" href="#部署脚本"><span>部署脚本</span></a></h2><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment"># docker-compose.yml</span>
