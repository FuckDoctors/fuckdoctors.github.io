import{_ as i,r as l,c as o,b as d,h as a,d as s,a as e,e as n,o as u}from"./app-EMofQacS.js";const r={},c=s('<h1 id="echarts-插件" tabindex="-1"><a class="header-anchor" href="#echarts-插件"><span>ECharts 插件</span></a></h1><p>让你的 VuePress 站点的 Markdown 文件支持 <a href="https://echarts.apache.org/zh/index.html" target="_blank" rel="noopener noreferrer">ECharts</a> 图表。</p><p>使用本插件时，需要自己安装 <code>echarts</code> 依赖，本插件会将 <code>echarts</code> 加到 <code>optimizeDeps</code> 中。<br> 另外，本插件使用了 <code>vueuse</code>，用来做宽度自适应。</p>',3),v=e("div",{class:"hint-container warning"},[e("p",{class:"hint-container-title"},"注意"),e("p",null,[n("本插件已经提交 PR，不需要自己实现，使用 "),e("code",null,"vuepress-theme-hope"),n(" 主题内置即可，这里仅保留记录。")])],-1),m=e("h2",{id:"配置",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#配置"},[e("span",null,"配置")])],-1),p=e("div",{class:"language-typescript line-numbers-mode","data-ext":"ts","data-title":"ts"},[e("pre",{ts:"",class:"language-typescript"},[e("code",null,[e("span",{class:"token comment"},"// customConfig.ts"),n(`
