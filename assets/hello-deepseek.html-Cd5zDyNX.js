import{_ as n,c as a,a as p,o as l}from"./app-CE7OIp24.js";const i={};function e(t,s){return l(),a("div",null,s[0]||(s[0]=[p(`<h1 id="deepseek-初体验" tabindex="-1"><a class="header-anchor" href="#deepseek-初体验"><span>DeepSeek 初体验</span></a></h1><p>春节期间，DeepSeek 真是大火，手头正好有个需求，我就体验了一下。<br><strong>它真的是很强大</strong>。</p><p>这里仅是简单记录一下，它生成的代码，更多关于 DeepSeek 的使用，大家可以去官网查看。</p><h2 id="需求" tabindex="-1"><a class="header-anchor" href="#需求"><span>需求</span></a></h2><p>我需要一个分割 DOM 树的功能，根据指定的节点，将 DOM 树分割成两个 DOM 树。<br> 一开始试了几个 DeepSeek 和 豆包 AI，都没达到想要的效果。</p><p>随后，重新提了自己的需求，将需求更明确化之后，试了一下 DeepSeek，它经过 5 分钟的推理之后，给出了一个非常不错的答案。</p><p>需求描述如下：</p><blockquote><p>帮我用javascript写一段按指定节点分割dom树的代码，分割后的dom树依旧内容完整。dom树可以是多层嵌套的。指定节点之前的dom树内容到该节点结束，自动补全剩余的dom树结束符。指定节点之后的dom树内容以该节点开始，自动补全之前的dom树开始符。</p></blockquote><h2 id="生成结果" tabindex="-1"><a class="header-anchor" href="#生成结果"><span>生成结果</span></a></h2><p>以下是实现按指定节点分割DOM树的JavaScript代码，返回分割后的两个完整DOM结构：</p><p>注：原来是以整个 document 来处理的，稍微改了一下，接受指定的 root。</p><div class="language-javascript" data-highlighter="shiki" data-ext="javascript" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-javascript"><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">// function splitDOMAtNode(originalNode) {</span></span>
