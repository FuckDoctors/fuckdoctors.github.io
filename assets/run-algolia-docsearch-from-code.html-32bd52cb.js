import{_ as e,r as t,o as c,c as o,a as s,b as n,d as l,e as p,h as i}from"./app-4dfd043d.js";const u={},r=s("h1",{id:"运行自己的-algolia",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#运行自己的-algolia","aria-hidden":"true"},"#"),n(" 运行自己的 algolia")],-1),d=s("br",null,null,-1),k={href:"https://vuepress-theme-hope.github.io/v2/zh/guide/feature/search.html#%E4%BD%BF%E7%94%A8-vuepress-docsearch",target:"_blank",rel:"noopener noreferrer"},m=i(`<p>提交 DocSearch 申请可能需要等待一段时间（我提交申请到最终下来花了 4 天），在申请下来之前，也体验下效果，自己使用旧版的方式爬取了内容。<br> 申请下来之后，使用 Crawler 更方便，所以之前的旧方式就不再用了。为了保留记录，写成一篇文章。</p><p>旧方式使用 Github Actions 做定期爬虫：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> Algolia Docsearch Action
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3);function v(h,b){const a=t("ExternalLinkIcon");return c(),o("div",null,[r,s("p",null,[n("使用 Algolia DocSearch 可以实现全文检索，对于搜索信息特别方便。"),d,n(" 参考 Hope 提供的"),s("a",k,[n("使用 @vuepress/docsearch"),l(a)]),n("。")]),p(" more "),m])}const g=e(u,[["render",v],["__file","run-algolia-docsearch-from-code.html.vue"]]);export{g as default};
